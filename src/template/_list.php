...
<html lang="en">
  <head>
    ...
    <title>Abigeater😊 Home Page</title>
    <style>
    ul li{
        font-size: 1.2rem;
    }
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand mb-0 h1" href="https://abigeater.com">Abigeater😊</a>
    ...
    <div class="container marketing">
        <div class="row">
		    ...
		    <li>Github：<a href="https://github.com/sohyunQVQ">SohyunQVQ</a></li>
                ...
                <hr>
                <div>
                    Copyright © 2019 Abigeater😊 <a href="http://www.beian.miit.gov.cn">粤ICP备19021677号</a>
                </div>
            </div>
        </div>
    </div>
